...
const lowToHighProtein = () => {
  // let arranged = foodData.sort((p1, p2) => {
  ...
  let arranged = foodData.map(() => {});
};
let tempArr1 = foodData;
const sortArrayAscending = () => {
  tempArr1.sort(function (a, b) {
...
const showSortedArray1 = () => {
  for (let i = 0; i < tempArr1.length; i++) {
    console.log(tempArr1[i]);
  }
};

let tempArr2 = foodData;
